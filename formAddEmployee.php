...
?>
		<div id="middle">
			<form action="addEmployee.php" method=post id=formGeneral>
				<h1><?php echo $translations["ADD_EMPLOYEE_FORM"] ?></h1><br>
				...
				<table id="formFields">
					...
					<tr>
						<td id=h-separator colspan=3 align="center"><input id="registerButton" type="submit" value="<?php echo $translations["LABEL_REGISTER_BUTTON"] ?>"></td>
					</tr>
				</table>
			</form>
		</div>
