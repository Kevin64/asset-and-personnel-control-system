...
?>
		<div id="middle">
			<form action=addAgent.php method=post id="formGeneral">
				<h1><?php echo $translations["ADD_AGENT_FORM"] ?></h1><br>
				...
				<table id="formFields">
					...
					<tr>
						<td id=h-separator colspan=3><input id="registerButton" type=submit value="<?php echo $translations["LABEL_REGISTER_BUTTON"] ?>"></td>
					</tr>
				</table>
			</form>
		</div>
