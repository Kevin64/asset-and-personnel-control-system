...
if ($total >= 1) {
	...
	//$queryFormatAnt = mysql_query("update manutencoes set patrimonio = '$patrimonio', formatacoesAnteriores = 'CONCAT(IFNULL(formatacoesAnteriores,''), $dataFormatacao)' where patrimonio = '$patrimonio'") or die ("Erro na query de atualização! ".mysql_error());
	//$queryFormatAnt = mysql_query("update manutencoes set patrimonio = '$patrimonio', formatacoesAnteriores = '$dataFormatacao' where patrimonio = '$patrimonio'") or die ("Erro na query de atualização! ".mysql_error());
	$queryFormatAnt = mysql_query("insert into manutencoes (patrimonioFK, dataFormatacoesAnteriores) values('$patrimonio', '$dataFormatacao')") or die ("Erro ao incluir os dados! ".mysql_error());
	...
	//$queryFormatAnt = mysql_query("insert into manutencoes (patrimonio, formatacoesAnteriores) values ('$patrimonio', 'CONCAT(IFNULL(formatacoesAnteriores,''), $dataFormatacao))'") or die ("Erro ao incluir os dados! ".mysql_error());
	$queryFormatAnt = mysql_query("insert into manutencoes (patrimonioFK, dataFormatacoesAnteriores) values('$patrimonio', '$dataFormatacao')") or die ("Erro ao incluir os dados! ".mysql_error());
