...
mysql_query("insert into patrimonio (patrimonio, predio, sala, descricao, nomeRecebedor, siapeRecebedor, ramal, dataEntrega, observacao, padrao, idUsuario, dataFormatacao, ad, marca, modelo, numSerie, processador, memoria, hd, sistemaOperacional, hostname, bios, mac, ip, emUso, lacre, etiqueta, tipo, tipoFW, tipoArmaz, gpu, modoArmaz, secBoot, vt, tpm) values ('$patrimonio', '$predio', '$sala', '$descricao', '$recebedor', '$siapeRecebedor', '$ramal', '$dataEntrega', '$observacao', '$padrao', '$idUsuario', '$ultimaFormatacao', '$ad', '$marca', '$modelo', '$numSerie', '$processador', '$memoria', '$hd', '$sistemaOperacional', '$hostName', '$bios', '$mac', '$ip', '$emUso', '$lacre', '$etiqueta', '$tipo', '$tipoFW', '$tipoArmaz', '$gpu', '$modoArmaz', '$secBoot', '$vt', '$tpm')") or die ("Erro ao tentar cadastrar patrimônio! ".mysql_error());
